(function(e) {
  function t(t) {
    for (
      var s, r, c = t[0], o = t[1], l = t[2], d = 0, m = [];
      d < c.length;
      d++
    )
      (r = c[d]),
    ...
    var s,
      ...
      o = function() {
        ...
        return a('div', { attrs: { id: 'app' } }, [
          a('div', { staticClass: 'container is-fluid' }, [
            a(
              'div',
              ...
              [
                ...
                a('div', { staticClass: 'tile is-ancestor' }, [
                  a(
                    'div',
                    {
                      staticClass: 'tile is-vertical is-parent is-3',
                      staticStyle: { 'min-height': '100%', overflow: 'scroll' },
                    },
                    [
                  ...
                  a('div', { staticClass: 'tile is-vertical is-parent is-9' }, [
                    a('p', { staticClass: 'title' }, [e._v('Chart')]),
                    a('div', { staticClass: 'tile is-horizontal is-12' }, [
                      a('div', { staticClass: 'tile is-child box is-10' }, [
                        a('p', { staticClass: 'panel-tabs' }, [
                          a(
                            'a',
                            {
                              key: 'overTime',
                              class: { 'is-active': e.isOverTimePanel },
                      ...
                      a(
                        'div',
                        { staticClass: 'tile is-vertical is-2 ml-1 pr-1' },
                        [
                          a(
                            'div',
                            {
                            ...
                            [
                              a('div', { staticClass: 'field' }, [
                                a('input', {
                                  ...
                                  on: {
                                    click: function(t) {
                                      return e.toggleMetric(e.metrics.ACTIVE);
                                    },
                                  },
                                }),
                                a(
                              ...
                              a('div', { staticClass: 'field' }, [
                                a('input', {
                                  staticClass: 'switch is-rounded is-danger',
                                  attrs: {
                                  ...
                                  on: {
                                    click: function(t) {
                                      return e.toggleMetric(e.metrics.DEATHS);
                                    },
                                  },
                                }),
                                a(
                                  'label',
                                  { attrs: { for: 'switchRoundedDanger' } },
                                  [e._v('Deaths')]
                                ),
                              ]),
                            ]
      ...
      l = [
        function() {
          var e = this,
            t = e.$createElement,
            a = e._self._c || t;
          return a('h4', { staticClass: 'subtitle' }, [
            e._v(' Yet Another Covid 19 Dashboard! '),
            a('br'),
            e._v(
              ' Basic Data Dashboard using Cassandra, Nifi, VueJS, SpringBoot, Bulma '
            ),
          ]);
        },
        function() {
      ...
      _ = S,
      D = Object(v['a'])(_, n, r, !1, null, null, null),
      R = D.exports,
      k = {
        responsive: !0,
        showAllTooltips: !0,
      ...
      w = E,
      x = Object(v['a'])(w, y, g, !1, null, null, null),
      O = x.exports,
      I = function() {
        var e = this,
          t = e.$createElement,
      ...
      M = [],
      $ = (a('caad'), a('a9e3'), ['danger', 'primary', 'warning', 'success']),
      P = {
      ...
      z = P,
      V = Object(v['a'])(z, A, M, !1, null, null, null),
      L = V.exports,
      N = {
        name: 'GlobalSummary',
        components: { SummaryMetricItem: L },
      ...
      F = N,
      H = Object(v['a'])(F, I, T, !1, null, null, null),
      q = H.exports,
      G = function() {
        var e = this,
          t = e.$createElement,
      ...
      J = U,
      W = (a('85f0'), Object(v['a'])(J, G, B, !1, null, null, null)),
      Y = W.exports,
      Z = ['Morocco'],
      K = {
      ...
      Q = {
        name: 'App',
        components: { RegionChart: O, GlobalSummary: q, RegionLineSummary: Y },
        data: function() {
          return {
            globalSummary: {
              confirmed: { value: 0 },
      ...
      X = Q,
      ee = (a('738e'), Object(v['a'])(X, o, l, !1, null, null, null)),
      te = ee.exports;
    a('15f5'), a('7051');
    (c['a'].config.productionTip = !1),
      (c['a'].config.cached = !0),
      (c['a'].prototype.$apiurl = c['a'].config.cached
        ? ''
        : 'http://localhost:8082/'),
      (c['a'].prototype.$apiurlsuffix = c['a'].config.cached ? '.json' : ''),
      new c['a']({
        render: function(e) {
          return e(te);
        },
...
//# sourceMappingURL=app.1de74564.js.map
